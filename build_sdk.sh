...
openssl_pkg() {
    ...
    local install_dir=$2
    local name="OpenSSL"
    local openssl_ver="1.0.2o"
    local openssl_url="https://www.openssl.org/source/openssl-$openssl_ver.tar.gz"
    local openssl_md5="44279b8557c3247cbe324e2322ecd114"
...
cryptopp_pkg() {
    ...
    local install_dir=$2
    local name="Crypto++"
    local cryptopp_ver="610"
    local cryptopp_url="http://www.cryptopp.com/cryptopp$cryptopp_ver.zip"
    local cryptopp_md5="1e16084171d6015104dbdfb5a7601393"
...
sodium_pkg() {
    ...
    local sodium_file="libsodium-$sodium_ver.tar.gz"
...
zlib_pkg() {
    ...
    local zlib_url="http://zlib.net/$name-$zlib_ver.tar.gz"
    local zlib_md5="1c9f62f0778697a09d36121ead88e08e"
    local zlib_file="$name-$zlib_ver.tar.gz"
    local zlib_dir="$name-$zlib_ver"
...
mediainfo_pkg() {
    ...
    local zenlib_ver="0.4.37"
    local zenlib_url="https://github.com/MediaArea/$zenlib_name/archive/v${zenlib_ver}.tar.gz"
    local zenlib_md5="31bd9badb2587e8a087dd0889e19b609"
    local zenlib_file="$zenlib_name.tar.gz"
    local zenlib_dir_extract="$zenlib_name-$zenlib_ver"
    local zenlib_dir="$zenlib_name-$zenlib_ver/Project/GNU/Library"

    local mediainfolib_name="MediaInfoLib"
    local mediainfolib_ver="18.03.1"
    local mediainfolib_url="https://github.com/MediaArea/MediaInfoLib/archive/v$mediainfolib_ver.tar.gz"
    local mediainfolib_md5="7e4ef35f688a4548c24cd9ecc69ce616"
    local mediainfolib_file="$mediainfolib_name-$mediainfolib_ver.tar.gz"
    local mediainfolib_dir_extract="$mediainfolib_name-$mediainfolib_ver"
    local mediainfolib_dir="$mediainfolib_name-$mediainfolib_ver/Project/GNU/Library"
